...
var version = process.versions.node.substr(0, process.versions.node.lastIndexOf('.'));

try {
    oracledbCLib =  require('../' + process.platform + '/' + version + '/build/Release/oracledb');
} catch (err) {
<<<<<<< HEAD
    if (err.code === 'MODULE_NOT_FOUND') {
        oracledbCLib = require('../' + process.platform + '/' + version + '/build/Debug/oracledb');
    } else {
        throw err;
    }
=======
